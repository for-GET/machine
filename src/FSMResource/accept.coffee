...
define [
  ...
  # Accept
  {
    ...
    accept_language_matches: () -> # : in
      ...
      tokenHandler = @transaction.h.acceptLanguage.chooseTokenHandler(provided) or {}
      return false  unless tokenHandler?.token
      @transaction.response.chosen.language = tokenHandler
      true
    has_accept_charset: () -> # : in
      acceptCharset = @transaction.h.acceptCharset
    ...
    accept_charset_matches: () -> # : in
      ...
      tokenHandler = @transaction.h.acceptCharset.chooseTokenHandler provided
      return false  unless tokenHandler?.token
      @transaction.response.chosen.charset = tokenHandler
      true
    has_accept_encoding: () -> # : in
      acceptEncoding = @transaction.h.acceptEncoding
    ...
    accept_encoding_matches: () -> # : in
      ...
      tokenHandler = @transaction.h.acceptEncoding.chooseTokenHandler provided
      return false  unless tokenHandler?.token
